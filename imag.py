...
class imag:
	...
	def __mul__(self, other):
		if isinstance(other, imag):
			return imag((self.a * other.a - self.b * other.b), (self.a * other.b + self.b * other.a))
	...
	def __rpow__(self, other):
		if isinstance(other, float) or isinstance(other, int):
			return imag((other ** self.a) * math.cos(self.b * math.log(other)), math.sin(self.b * math.log(other)))
